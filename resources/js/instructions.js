    ...
    async copyInstructions() {
        try {
            ...
            const instructionsContent =
                document.querySelector(".prose p")?.textContent || "";
            const customerComments =
                document.querySelector(".bg-cyan-100 p")?.textContent || "";
...
${customerComments.trim()}
            ...
            tooltip.className =
                "absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded";
